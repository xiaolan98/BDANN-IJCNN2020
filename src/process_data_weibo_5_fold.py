...
def write_data(flag, image, text_only, fold_id):
    def read_post(flag):
...
def get_data(text_only, fold_id):
    # text_only = False
    ...
    train_data, event_num = write_data("train", image_list, text_only, fold_id)
    valiate_data, _ = write_data("test", image_list, text_only, fold_id)
    test_data, _ = write_data("test", image_list, text_only, fold_id)
